...
#pragma region Buffer Byte Size

	/* Constant buffers must be a multiple of the minimum hardware
	// allocation size (usually 256 bytes).  So round up to nearest
	// multiple of 256. add 255 and then mask off
...
#pragma region SubmeshGeometry
// Defines a subrange of geometry in a MeshGeometry.  Useful when multiple
...
struct SubmeshGeometry
{
	...
	// To be used for Frsutum Culling.
...
struct Material
{
	...
	// Dirty flag indicating the material has changed and constant buffer must be updated.
	// Because there is a material constant buffer for each FrameResource, we have to apply the
